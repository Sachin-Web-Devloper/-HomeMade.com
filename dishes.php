            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Store</a></li>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Pune</p>
                                    <h5>Phone: 9322755952</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other stream_socket_shutdown who benefit from having partnered with us.</p>
                                </div>
                            </div>
                        </div>
                    </div>
